...
If anything is ambiguous, choose the safest conservative behavior and document it clearly in the `requirements`, `assumptions`, and `logic.error_conditions` sections of the contract.
